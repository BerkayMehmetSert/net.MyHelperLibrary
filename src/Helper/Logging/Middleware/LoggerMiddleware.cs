using Helper.Date;
using Helper.Logging.Constants;
using Helper.Logging.Model;
using Microsoft.AspNetCore.Diagnostics;
using Microsoft.AspNetCore.Http;
using Newtonsoft.Json.Linq;

namespace Helper.Logging.Middleware;
...
public class LoggerMiddleware
{
    ...
    private static void LogErrorHandler(LogModel log, System.Exception exception)
    {
    ...
    private static Dictionary<string, string> FilterSensitiveHeaders(IHeaderDictionary headers)
    {
